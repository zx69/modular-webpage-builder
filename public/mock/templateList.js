...
export default [
  {
    id: '1',
    cover: `${process.env.BASE_URL}mock/preset-image/d6748cc280ec327fd6e6f0ae2ddad7e16a5497d41c0e97-O2mlZU_fw658.png`,
    name: '模板一',
    content: [
      {
        type: 'module',
            ...
            children: [
              ...
              },
              {
                ...
                mobile: {
                  props: {
                    valueKey: 'desc',
                    mobileSizeRadio: 0.4166666666666667,
                    overflowLine: 2,
                  },
                },
                component: 'InputableText',
            ...
            children: [
              ...
              },
              {
                ...
                style: {
                  display: 'grid',
                  gap: '16px 5.88%',
                  gridTemplateColumns: 'repeat(3, 29.41%)',
                  flex: '1',
                },
                mobile: {
                  style: {
